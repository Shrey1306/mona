# From Three.js (leeperrydecal folder): leeperrydecal modified Gaussian Splattering Shoot Function into a surgical incision function. Choose surgical tool and annotate
...
# [Real time Mesh to 2D Annotation Capture using timeseries and .png (testing folder)
